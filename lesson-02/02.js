...
let dice1 = Math.floor(Math.random() * 7); // Генерация случайного числа от 1 до 6 для первого кубика
let dice2 = Math.floor(Math.random() * 7); // Генерация случайного числа от 1 до 6 для второго кубика
